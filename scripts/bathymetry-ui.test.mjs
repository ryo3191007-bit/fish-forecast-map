...
assert.match(metadata.sourceResolution, /15 arc-second|60 arc-second/);
assert.ok([1 / 60, 1 / 240].includes(dem.cellSizeDegrees));
assert.match(bathy, /GEBCO_2026 15 arc-second primary \/ ETOPO 2022 60 arc-second fallback/);
