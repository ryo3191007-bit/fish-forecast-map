...
assert.equal(isCreateSpotRpcMissing({ code: "PGRST202", message: "function public.create_my_user_fishing_spot_with_details was not found" }), true, "missing RPC uses compatibility save");
assert.equal(isCreateSpotRpcMissing({ code: "PGRST202", message: "function public.unrelated_function was not found" }), false, "unrelated missing objects do not use compatibility save");
