...
assert.match(map, /className="mapBottomOverlays"[\s\S]*?mapLayerMode === "bathymetry"[\s\S]*?className="bathymetryPointCard"/, "depth card remains in the bottom overlay stack");
