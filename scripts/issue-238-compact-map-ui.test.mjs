...
assert.match(map, /<div className="mapFrame">\s*<MapLayerToggle[\s\S]*?<div className="mapShell">\s*<div className=\{`mapViewport[\s\S]*?<div ref=\{containerRef\} className="map"/, "toggle precedes and is adjacent to the map viewport");
