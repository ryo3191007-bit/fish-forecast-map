...
values
  ...
  ('ouka-port', '相賀漁港', '唐津湾北部', 33.506447, 129.956971, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('kodomo-port', '小友漁港', '唐津湾北部', 33.54684, 129.906629, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('kabeshima-port', '加部島漁港', '唐津湾北部', 33.55655, 129.8894, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('hado-port', '波戸漁港', '唐津湾北部', 33.5463, 129.859, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('haregi-port', '晴気漁港', '唐津湾北部', 33.4351, 129.811, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('tobo-port', '唐房漁港', '唐津湾北部', 33.482, 129.94, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('minatohama-port', '湊浜漁港', '唐津湾北部', 33.526093, 129.95497, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('nagoya-port', '名護屋漁港', '唐津湾北部', 33.53261, 129.877582, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('yobuko-port', '呼子漁港', '唐津湾北部', 33.54585, 129.89076, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
  ('takakushi-port', '高串漁港', '唐津湾北部', 33.4225, 129.826, '漁港', '不明', 'approximate', array[]::text[], array[]::text[], array['港の概略代表点であり、実釣位置、堤防先端、入口、駐車位置、危険箇所を示しません。', '一般立入・釣り可否は未確認です。現地表示と管理者の最新案内を確認してください。', '過去の魚種・設備・地形情報は地点詳細の参考情報であり、現在の釣果や利用可否を保証しません。']::text[], true),
